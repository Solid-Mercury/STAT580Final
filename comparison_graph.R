...
ggplot(df, aes(x = rank,y = testerror, color = method)) + geom_smooth() + theme_bw()  #label{comparison_testerror}
ggplot(df, aes(x = rank,y = trainingerror, color = method)) + geom_smooth() + theme_bw()
